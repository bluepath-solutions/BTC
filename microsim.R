...
# it is for a half-cycle correction
...
dxa_fracs_wo_previous_frac <- total_fractures_wo_previous_fracture
dxa_fracs_wo_previous_frac_s1 <- total_fractures_wo_previous_fracture_s1
dxa_fracs_with_previous_frac <- total_fractures_with_previous_fracture
dxa_fracs_with_previous_frac_s1 <- total_fractures_with_previous_fracture_s1
...
total_dxa_cost_with_prev_frac <- total_dxa_cost*(dxa_fracs_with_previous_frac/(dxa_fracs_with_previous_frac+dxa_fracs_wo_previous_frac))
total_med_cost_with_prev_frac <- total_med_cost*(total_fractures_with_previous_fracture/(total_fractures_with_previous_fracture+total_fractures_wo_previous_fracture))
...
total_direct_with_prev_frac_cost <-  total_dxa_cost_with_prev_frac + total_med_cost_with_prev_frac + total_frac_cost_with_prev_frac
                                    
total_dxa_cost_with_prev_frac_s1 <- total_dxa_cost_s1*(dxa_fracs_with_previous_frac_s1/(dxa_fracs_with_previous_frac_s1+dxa_fracs_wo_previous_frac_s1))
total_med_cost_with_prev_frac_s1 <- total_med_cost_s1*(total_fractures_with_previous_fracture_s1/(total_fractures_with_previous_fracture_s1+total_fractures_wo_previous_fracture_s1))
...
total_direct_with_prev_frac_cost_s1 <- total_dxa_cost_with_prev_frac_s1 + total_med_cost_with_prev_frac_s1 + total_frac_cost_with_prev_frac_s1
                        
total_dxa_cost_wo_prev_frac <- total_dxa_cost*(dxa_fracs_wo_previous_frac/(dxa_fracs_wo_previous_frac+dxa_fracs_with_previous_frac))
total_med_cost_wo_prev_frac <- total_med_cost*(total_fractures_wo_previous_fracture/(total_fractures_wo_previous_fracture+total_fractures_with_previous_fracture))
...
total_direct_wo_prev_frac_cost <-  total_dxa_cost_wo_prev_frac + total_med_cost_wo_prev_frac + total_frac_cost_wo_prev_frac
                                    
total_dxa_cost_wo_prev_frac_s1 <- total_dxa_cost_s1*(dxa_fracs_wo_previous_frac_s1/(dxa_fracs_wo_previous_frac_s1+dxa_fracs_with_previous_frac_s1))
total_med_cost_wo_prev_frac_s1 <- total_med_cost_s1*(total_fractures_wo_previous_fracture_s1/(total_fractures_wo_previous_fracture_s1+total_fractures_with_previous_fracture_s1))
...
total_direct_wo_prev_frac_cost_s1 <-  total_dxa_cost_wo_prev_frac_s1 + total_med_cost_wo_prev_frac_s1 + total_frac_cost_wo_prev_frac_s1
...
prev_frac_data <- data.frame(prev_fracs_per_yr,
                             ...
                             total_dxa_cost_with_prev_frac, total_med_cost_with_prev_frac, total_frac_cost_with_prev_frac,
                             ...
                             total_dxa_cost_with_prev_frac_s1, total_med_cost_with_prev_frac_s1, total_frac_cost_with_prev_frac_s1,
...
no_prev_frac_data <- data.frame(prev_no_fracs_per_yr,
                                ...
                                total_dxa_cost_wo_prev_frac, total_med_cost_wo_prev_frac, total_frac_cost_wo_prev_frac,
                             ...
                             total_dxa_cost_wo_prev_frac_s1, total_med_cost_wo_prev_frac_s1, total_frac_cost_wo_prev_frac_s1,
