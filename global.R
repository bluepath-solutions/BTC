...
treat_cost <- list(China = c(421, 0, 218, 316, 449, 0, 0, 503, 801, 0)/12,
                   ...
                   Thailand = c(150.81, 432.63, 374.88, 369.6, 457.05, 841.5, 0, 578.16, 6408.6, 0)/12,
                   `South Korea` = c(0.67, 17.03, 0.64, 47.94, 273.56, 192.08, 0.94, 0.63, 290.78, 1822.41)*price_inflation_2012_2019) 
