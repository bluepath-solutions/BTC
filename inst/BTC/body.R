                ...
                boxPlus(id = "Risk_Fact", title = "Risk Factors", width = 12, closable = FALSE, collapsible = TRUE,
                        ...
                        dropdown_menu = dropdownItemList(
                          ...
                          dropdownItem(name = HTML("Risk factor prevalence was estimated from analyzing National Health and Nutrition Examination Survey (NHANES), <br/>
                                                     ...
                                                     was conducted to estimate the population-level estimates of risk factors for the female population aged â¥ 65 years. <br/>
                                                     ...
                                                     generated for women â¥ 65 years old. NHANES data were used to estimate mean BMD and the standard deviation."))),
                        tags$br(),
                        tags$table(id = "inputs-table"
                                   , style = "width: 100%"
                                   , tags$tr(
                ...
                boxPlus(id="FxrCostInp", title = "Fracture Costs", width = 12, closable = FALSE, collapsible = TRUE,
                        ...
                        dropdown_menu = dropdownItemList(
                          dropdownItem(name = HTML("Direct medical costs related to fracture were derived from Weaver et al. This retrospective claims analysis included<br/>
                                                     ...
                                                     which likely corresponds to duplicate capture of osteoporosis medication costs in the model. âOtherâ costs were not<br/> 
                        ...
                        fluidRow(
                          ...
                          column(width = 4, tags$style("#costinpt1 {background-color:#dfdfdf;}"), numericInput(inputId = "costinpt1", label = NULL, value = "2401", step = 1)),
                          column(width = 4, tags$style("#costinpt2 {background-color:#dfdfdf;}"), numericInput(inputId = "costinpt2", label = NULL, value = "2401"))),
                        fluidRow(
                ...
                boxPlus(id = "scenarios_box", title = "Treatment, Identification Rates & Time Horizon", width = 12, closable = FALSE, collapsible = TRUE,
                        ...
                        dropdown_menu = dropdownItemList(
                          dropdownItem(name = HTML("Identification Rate in the Base Case scenario was based on Lewiecki et al. 2016. This analysis identified the proportion of Medicare patients with <br/>
                                                     â¥ 1 DXA scan each year from 2002-2014 (11.3% in 2014), based on health care claims and enrollment data from the 5% sample of Medicare fee-for-service  <br/>
                        ...
                        fluidRow(
                          ...
                          column(width = 4, tags$style("#basecaseTx {background-color:#dfdfdf;}"), numericInput(inputId = "basecaseTx", label = NULL, value = "35.90", step = 0.1))),
                        fluidRow(
              ...
              fluidRow(
                boxPlus(
                  ...
                  p(HTML("The following studies used in the economic model involved an Amgen employee or were sponsored by Amgen. These disclosures are specific to what is listed within the publication or source document used to development the economic model.<br/>
                           ...
                           <ul>
                            <li>Freemantle N, Cooper C, Diez-Perez A, Gitlin M, Radcliffe H, Shepherd S, et al. Results of indirect and mixed treatment comparison of fracture efficacy for osteoporosis treatments: a meta-analysis. Osteoporos Int. 2013;24(1):209â17. <br/>
                           <ul>
              ...
              fluidRow(
                boxPlus(
                  ...
                  p(HTML("The following studies were used in the economic model as model inputs or as source evidence used to inform model inputs. Other evidence was used to support model assumptions and such evidence are included as references but have not been summarized below.
                           ...
                           <ul> 
                            <li>This analysis uses an economic simulation model developed to assess the clinical and economic burden of osteoporotic fractures in the US with and without policy changes. The model takes a population perspective focused on women â¥ 65 years old. Multiple sources were utilized to develop the simulation and analysis including epidemiology, fracture risk factors, rate of fracture based on risk factors, DXA scanning and treatment rates, as well as direct and indirect fracture costs.</li>
                            </ul>
                             </ul>  
                           <ul>
                            <li>Centre for Metabolic Bone Diseases, University of Sheffield, UK. FRAXÂ® Fracture Risk Assessment Tool. Available from: https://www.sheffield.ac.uk/FRAX/  </li>
                           <ul>
                            <li>The University of Sheffield launched the FRAXÂ® tool in 2008. The FRAXÂ® algorithms give the 10-year probability of fracture. The output is a 10-year probability of hip fracture and the 10-year probability of a major osteoporotic fracture (clinical spine, forearm, hip or shoulder fracture).The FRAXÂ® model was developed from studying population-based cohorts from Europe, North America, Asia and Australia. The simplified tables that are publicly accessible are structured by geography and race. The US specific tables include Caucasian, Asian, black and Hispanic. All data tables are structured by fracture output and provided in 5-year age increments.</li>
                           </ul>
                              </ul>
                           <ul>
                           ...
                           <ul>
                            <li>Pike, CT, Birnbaum HG, Schiller M, Swallow E, Burge RT, Edgell ET. Prevalence and costs of osteoporotic patients with subsequent non-vertebral fractures in the US.  Osteoporos Int. 2011;22:2611â2621. </li>
                           <ul>
                            <li>A retrospective analysis of administrative claims from 1999 through 2006 of  privately-insured (ages 18â64 years) and Medicare (ages 65+ years) patients with â¥1 subsequent osteoporosis-related non-vertebral fracture within a year the initial non-vertebral fractures were included. Patients were matched to controls who experiences an initial non-vertebral fracture but no subsequent fractures. Subsequent fractures were included if occurring >3 months after the incident fracture or >6 months were required for fractures occurring at the site as the initial fracture. The analysis focused on the prevalence of subsequent fractures and the costs between the two cohorts. A total 48,742 Medicare patients were included in the analysis with at least one non-vertebral fracture.</li>
                           </ul>
                              </ul>
                           <ul>
                            <li>Freemantle N, Cooper C, Diez-Perez A, Gitlin M, Radcliffe H, Shepherd S, et al. Results of indirect and mixed treatment comparison of fracture efficacy for osteoporosis treatments: a meta-analysis. Osteoporos Int. 2013;24(1):209â17.</li>
                           <ul>
                           ...
                           <ul>
                            <li>King AB, Saag KG, Burge RT, Pisu M, Goel N. Fracture Reduction Affects Medicare Economics (FRAME): Impact of increased osteoporosis diagnosis and treatment. Osteoporos Int. 2005;16(12):1545â57.</li>
                           <ul>
                            <li>An economic model used to estimate the impact of increased diagnosis and treatment. The model was a Markov structure and was used to predict fracture incidence and costs among postmenopausal women â¥ 65 years old over a 3 year period (2001-2003). The primary outputs of the model were focused on estimating the budget impact of testing an additional 1 million women.  As part of the model, secondary evidence was used as inputs with a key input focused on the percentage of patients treated following a bone mineral density test. The rate of treatment was based on data from Medicare supplemental and retiree plans, specifically the MarketScan claims database.</li>
                            </ul>
                              </ul>
                           <ul>
                           ...
                           <ul>
                            <li>Imaz I, Zegarra P, GonzÃ¡lez-EnrÃ�quez J, Rubio B, Alcazar R, Amate JM. Poor bisphosphonate adherence for treatment of osteoporosis increases fracture risk: systematic review and meta-analysis. Osteoporos Int. 2010 Nov;21(11):1943â51.</li>
                           <ul>
                           ...
                           <ul>
                            <li>Lewiecki EM, Adler R, Curtis J, Gagel R, Saag K, Singer A, et al. Hip Fractures and Declining DXA Testing: At a Breaking Point? J Bone Miner Res. 2016 Sep;31(S1):S1â411.</li>
                           <ul>
